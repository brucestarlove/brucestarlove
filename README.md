...
- `Starscape Digital` Client work for local Cincinnati small businesses, including website development, visual designs, social media profile creation & management, social content strategy, content development. Working to multiply myself in these small client endeavors through freelancers, contractors, employees and most keenly: student developers looking for their first bits of real world experience, connecting them with small businesses that don't need a lot. For the good of both, not profit.
- `starscape.app` - an expansive, multi-pillar, "everything" social media platform. I began prototyping this in July, ran into architecture hiccups, started rebuilding but spun off into `Earth Village` to deliver that, Virtual Villages and Hellscape Connect first before integrating it all into Starscape.
- `stealth creative project` - focused on youth empowerment
- experimenting with all sorts of new AI tools.
- `SEEDS` Design, Wordpress development of SEEDSdot.com (including unseen event calendar, tickets and account functionality). Prototyped Virtual Reality spaces for yoga, meditation and other classes. Development paused.
- endless unrealized ideas and designs. i need more money and assistance.
